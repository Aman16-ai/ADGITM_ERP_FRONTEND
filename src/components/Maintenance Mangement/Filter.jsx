    ...
    <div className="w-auto h-auto flex justify-center items-center mb-4">
      <div className="mr-2">
          ...
          <select
            ...
            className="form-input h-11  p-2 block w-full rounded-md border-gray-300 border-2 shadow-sm focus:border-blue-300 focus:ring focus:outline-none focus:ring-blue-200 focus:ring-opacity-50"
          >
      ...
      <button
        ...
        className={`border-2 border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white font-semibold py-2 px-4 rounded focus:outline-none focus:shadow-outline h-10  mr-4`}
      >
        Default
      </button>
    </div>
